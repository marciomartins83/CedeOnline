...
class getSecurity_Authenticator_FormLogin_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authenticator.form_login.main'] = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($b, ($container->privates['app.user_provider'] ?? $container->load('getApp_UserProviderService')), $c, $d, ['login_path' => 'app_login', 'check_path' => 'app_login', 'enable_csrf' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'use_forward' => false, 'require_previous_session' => false, 'post_only' => true, 'form_only' => false]);
    }
}
