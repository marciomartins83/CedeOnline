...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\AuditController' => 'getAuditControllerService',
            'App\\Controller\\Admin\\ModuloController' => 'getModuloControllerService',
            'App\\Controller\\Admin\\PermissaoController' => 'getPermissaoControllerService',
            'App\\Controller\\Admin\\UserController' => 'getUserControllerService',
            'App\\Controller\\Caixa\\CaixaController' => 'getCaixaControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5ysND+xGfD', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GLaIMfCpqi', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ibp3eeFs2w', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\AuditController', 'App\\Controller\\Admin\\ModuloController', 'App\\Controller\\Admin\\PermissaoController', 'App\\Controller\\Admin\\UserController', 'App\\Controller\\Caixa\\CaixaController', 'App\\Controller\\DashboardController', 'App\\Controller\\HomeController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qLQs1NRHGH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lc54W48-dj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('n-Z6QuELkN', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zfjzwBWczc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Qat6LSuI5l', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ExvDxs2M2W', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WaFukzuHb4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\ModuloVoter'] ?? $container->load('getModuloVoterService'));
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\CaixaRepository' => ['privates', 'App\\Repository\\CaixaRepository', 'getCaixaRepositoryService', true],
            'App\\Repository\\LocalCaixaRepository' => ['privates', 'App\\Repository\\LocalCaixaRepository', 'getLocalCaixaRepositoryService', true],
            'App\\Repository\\ModoMovimentoRepository' => ['privates', 'App\\Repository\\ModoMovimentoRepository', 'getModoMovimentoRepositoryService', true],
            'App\\Repository\\ModuloRepository' => ['privates', 'App\\Repository\\ModuloRepository', 'getModuloRepositoryService', true],
            'App\\Repository\\MovimentoRepository' => ['privates', 'App\\Repository\\MovimentoRepository', 'getMovimentoRepositoryService', true],
            'App\\Repository\\OrigemMovimentoRepository' => ['privates', 'App\\Repository\\OrigemMovimentoRepository', 'getOrigemMovimentoRepositoryService', true],
            'App\\Repository\\PagadorRepository' => ['privates', 'App\\Repository\\PagadorRepository', 'getPagadorRepositoryService', true],
            'App\\Repository\\PermissaoRepository' => ['privates', 'App\\Repository\\PermissaoRepository', 'getPermissaoRepositoryService', true],
            'App\\Repository\\ResponsavelRepository' => ['privates', 'App\\Repository\\ResponsavelRepository', 'getResponsavelRepositoryService', true],
            'App\\Repository\\StatusRepository' => ['privates', 'App\\Repository\\StatusRepository', 'getStatusRepositoryService', true],
            'App\\Repository\\TipoMovimentoRepository' => ['privates', 'App\\Repository\\TipoMovimentoRepository', 'getTipoMovimentoRepositoryService', true],
            ...
            'App\\Repository\\CaixaRepository' => '?',
            'App\\Repository\\LocalCaixaRepository' => '?',
            'App\\Repository\\ModoMovimentoRepository' => '?',
            'App\\Repository\\ModuloRepository' => '?',
            'App\\Repository\\MovimentoRepository' => '?',
            'App\\Repository\\OrigemMovimentoRepository' => '?',
            'App\\Repository\\PagadorRepository' => '?',
            'App\\Repository\\PermissaoRepository' => '?',
            'App\\Repository\\ResponsavelRepository' => '?',
            'App\\Repository\\StatusRepository' => '?',
            'App\\Repository\\TipoMovimentoRepository' => '?',
    ...
    protected static function getLocaleAwareListenerService($container)
    {
        return $container->privates['locale_aware_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleAwareListener(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('pt_BR'));
    ...
    {
        return $container->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'pt_BR', ($container->services['router'] ?? self::getRouterService($container)), false, []);
    }
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['app.user_provider'] ?? $container->load('getApp_UserProviderService'));
    ...
    {
        return $container->privates['translation.locale_switcher'] = new \Symfony\Component\Translation\LocaleSwitcher('pt_BR', new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('pt_BR'));
            yield 1 => ($container->privates['translator.default'] ?? self::getTranslator_DefaultService($container));
