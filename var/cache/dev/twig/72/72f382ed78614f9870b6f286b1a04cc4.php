...
class __TwigTemplate_d919d9ba6392218e1c69e1148363049e extends Template
{
        ...
        yield "
                        ...
                        <div class=\"row\">
                            <div class=\"col-md-12\">
                                ";
        // line 33
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 33, $this->source); })()), "roles", [], "any", false, false, false, 33), 'row');
        yield "
                            </div>
                        </div>
                        <div class=\"row\">
                            <div class=\"col-md-12\">
                                ";
        // line 38
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 38, $this->source); })()), "ativo", [], "any", false, false, false, 38), 'row');
        yield "
                            </div>
                        </div>
...
";
    ...
    {
        return array (  169 => 49,  159 => 42,  152 => 38,  144 => 33,  136 => 28,  130 => 25,  122 => 20,  116 => 17,  110 => 14,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %} ", "admin/user/new.html.twig", "/srv/http/CedeOnline/templates/admin/user/new.html.twig");
    }
}
